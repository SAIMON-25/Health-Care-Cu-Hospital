...
import logo from '../bg_images/health Care CU Hospital.png';
          ...
          <div className="login-form-inner">
            <div className="login-logo-wrap">
              <div className="login-logo-box">
                <img src={logo} alt="Health Care CU Hospital Logo" className="login-logo" />
              </div>
              <h1 className="login-brand">Health Care CU Hospital</h1>
            </div>

            <h2 className="login-heading">Sign In</h2>
            <p className="login-subtitle">
              Welcome to Health Care CU Hospital. Enter your credentials to continue.
            </p>
